...
module.exports.run = async function ({
    ...
    try {
        const res = await axios.get(`https://api.leanhtruong.net/v2/taixiu.php?api_key=LEANHTRUONG=IgPpSrAakFIZXkYx1Pbar9oYwIvLXxSj4dybZGca4qBFz7LHU0=APIKEY=PLANFREE&bet=tài`);
        var data = res.data;
