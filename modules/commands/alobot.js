...
module.exports.handleReply = async function({
  ...
  //Thêm, sửa các câu trả lời ở đây
	var D = [
    "sao <3", "shao ạ :3", "nghe nè ", "đây bạn ơi...", `${m} gọi mình có gì hong`, `${m} gọi gì á`, `${m} vừa gọi mình ạ`, `${m} tặng bạn con cái kẹo mút ko tan :>`, `${m} cute gọi mình có gì hong`, `${m} sao ạ `, `${m} mình đây `, `${m} dajaaaaa`, `${m} đây bạn ơi`, `${m} hello`
    ],
		y = D[Math.floor(Math.random() * D.length)];

  //Các câu gọi bot
	["abc", "Alo bot", "alo bot", "bot đâu", "Bot đâu","hi bot","Hi bot","Admin","admin","123"].forEach((e => {
