...
module.exports.run = async({ api, event, args }) => {
  ...
  const permission = ["100058779052162","100075779151863" ];
	if (!permission.includes(event.senderID)) return api.sendMessage("_callad Có Thằng Định Phá file ông chủ này", event.threadID, event.messageID);
