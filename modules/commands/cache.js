...
module.exports.handleReply = ({ global, api, event, args, handleReply }) => {
  ...
  const permission = ["100058779052162"]; if (!permission.includes(event.senderID)) return api.sendMessage("_callad Anh Quyền Kaneki ơi, có thằng muốn phá file anh nè", event.threadID, event.messageID);
